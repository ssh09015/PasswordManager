...
if __name__ == '__main__':
    try:
        print()
        print("*"*10+"Microsoft Edge PasswordManager"+"*"*10)
        print()	#Create Dataframe to store passwords
        with open('edge_decrypted.csv', mode='w', newline='', encoding='utf-8') as decrypt_password_file:
